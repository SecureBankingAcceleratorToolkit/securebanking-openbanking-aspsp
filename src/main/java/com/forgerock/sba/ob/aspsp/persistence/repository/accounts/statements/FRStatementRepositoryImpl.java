 ...
 * under the License.
 */
package com.forgerock.sba.ob.aspsp.persistence.repository.accounts.statements;

import com.forgerock.sba.ob.aspsp.persistence.document.account.FRStatement;
