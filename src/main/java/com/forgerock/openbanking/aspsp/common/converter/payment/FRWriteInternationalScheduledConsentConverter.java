...
import com.forgerock.openbanking.aspsp.common.converter.common.FRAccountIdentifierConverter;
import com.forgerock.openbanking.aspsp.persistence.domain.payment.FRWriteInternationalScheduledConsent;
import com.forgerock.openbanking.aspsp.persistence.domain.payment.FRWriteInternationalScheduledConsentData;
import com.forgerock.openbanking.aspsp.persistence.domain.payment.FRWriteInternationalScheduledDataInitiation;
import uk.org.openbanking.datamodel.account.OBCashAccount3;
import uk.org.openbanking.datamodel.payment.*;

import static com.forgerock.openbanking.aspsp.common.converter.common.FRAccountIdentifierConverter.*;
import static com.forgerock.openbanking.aspsp.common.converter.common.FRAmountConverter.*;
import static com.forgerock.openbanking.aspsp.common.converter.common.FRFinancialInstrumentConverter.*;
import static com.forgerock.openbanking.aspsp.common.converter.payment.FRChargeBearerConverter.toFRChargeBearerType;
import static com.forgerock.openbanking.aspsp.common.converter.payment.FRChargeBearerConverter.toOBChargeBearerType1Code;
import static com.forgerock.openbanking.aspsp.common.converter.payment.FRDataAuthorisationConverter.toFRDataAuthorisation;
import static com.forgerock.openbanking.aspsp.common.converter.payment.FRDataSCASupportDataConverter.toFRDataSCASupportData;
import static com.forgerock.openbanking.aspsp.common.converter.payment.FRExchangeRateConverter.*;
import static com.forgerock.openbanking.aspsp.common.converter.payment.FRInstructionPriorityConverter.*;
import static com.forgerock.openbanking.aspsp.common.converter.payment.FRPaymentRiskConverter.toFRRisk;
import static com.forgerock.openbanking.aspsp.common.converter.payment.FRPaymentSupplementaryDataConverter.toFRSupplementaryData;
import static com.forgerock.openbanking.aspsp.common.converter.payment.FRPaymentSupplementaryDataConverter.toOBSupplementaryData1;
import static com.forgerock.openbanking.aspsp.common.converter.payment.FRPermissionConverter.toFRPermission;
import static com.forgerock.openbanking.aspsp.common.converter.payment.FRReadRefundAccountConverter.toFRReadRefundAccount;
import static com.forgerock.openbanking.aspsp.common.converter.payment.FRRemittanceInformationConverter.*;
