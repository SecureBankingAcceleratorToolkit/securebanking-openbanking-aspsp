...
import com.forgerock.openbanking.aspsp.persistence.domain.account.FRReadConsentResponse;
import com.forgerock.openbanking.aspsp.persistence.domain.account.FRReadConsentResponseData;
import uk.org.openbanking.datamodel.account.OBReadConsentResponse1;
import uk.org.openbanking.datamodel.account.OBReadConsentResponse1Data;

import static com.forgerock.openbanking.aspsp.common.converter.account.FRAccountRiskConverter.toFRAccountRisk;
import static com.forgerock.openbanking.aspsp.common.converter.account.FRAccountRiskConverter.toOBRisk2;
import static com.forgerock.openbanking.aspsp.common.converter.account.FRExternalPermissionsCodeConverter.toFRExternalPermissionsCodeList;
import static com.forgerock.openbanking.aspsp.common.converter.account.FRExternalPermissionsCodeConverter.toOBExternalPermissions1CodeList;
import static com.forgerock.openbanking.aspsp.common.converter.account.FRExternalRequestStatusCodeConverter.toFRExternalRequestStatusCode;
import static com.forgerock.openbanking.aspsp.common.converter.account.FRExternalRequestStatusCodeConverter.toOBExternalRequestStatus1Code;
import static com.forgerock.openbanking.aspsp.common.converter.account.FRLinksConverter.toFRLinks;
import static com.forgerock.openbanking.aspsp.common.converter.account.FRLinksConverter.toLinks;
import static com.forgerock.openbanking.aspsp.common.converter.account.FRMetaConverter.toFRMeta;
import static com.forgerock.openbanking.aspsp.common.converter.account.FRMetaConverter.toMeta;
