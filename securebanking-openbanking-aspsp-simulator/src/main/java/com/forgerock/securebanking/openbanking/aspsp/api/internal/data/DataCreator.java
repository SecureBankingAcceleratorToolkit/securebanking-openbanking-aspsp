 ...
 */
package com.forgerock.securebanking.openbanking.aspsp.api.internal.data;

import com.forgerock.securebanking.common.openbanking.domain.account.data.FRAccountData;
import com.forgerock.securebanking.common.openbanking.domain.account.data.FRPartyData;
import com.forgerock.securebanking.openbanking.aspsp.persistence.document.account.*;
...
import com.forgerock.securebanking.openbanking.aspsp.persistence.repository.accounts.beneficiaries.FRBeneficiaryRepository;
import com.forgerock.securebanking.openbanking.aspsp.persistence.repository.accounts.directdebits.FRDirectDebitRepository;
import com.forgerock.securebanking.openbanking.aspsp.persistence.repository.accounts.offers.FROfferRepository;
import com.forgerock.securebanking.openbanking.aspsp.persistence.repository.accounts.party.FRPartyRepository;
import com.forgerock.securebanking.openbanking.aspsp.persistence.repository.accounts.products.FRProductRepository;
import com.forgerock.securebanking.openbanking.aspsp.persistence.repository.accounts.scheduledpayments.FRScheduledPaymentRepository;
import com.forgerock.securebanking.openbanking.aspsp.persistence.repository.accounts.standingorders.FRStandingOrderRepository;
import com.forgerock.securebanking.openbanking.aspsp.persistence.repository.accounts.statements.FRStatementRepository;
import com.forgerock.securebanking.openbanking.aspsp.persistence.repository.accounts.transactions.FRTransactionRepository;
...
import static com.forgerock.securebanking.openbanking.aspsp.common.converter.account.FRAccountBeneficiaryConverter.toFRAccountBeneficiary;
import static com.forgerock.securebanking.openbanking.aspsp.common.converter.account.FRCashBalanceConverter.toFRBalanceType;
import static com.forgerock.securebanking.openbanking.aspsp.common.converter.account.FRCashBalanceConverter.toFRCashBalance;
import static com.forgerock.securebanking.openbanking.aspsp.common.converter.account.FRDirectDebitConverter.toFRDirectDebitData;
import static com.forgerock.securebanking.openbanking.aspsp.common.converter.account.FRFinancialAccountConverter.toFRFinancialAccount;
import static com.forgerock.securebanking.openbanking.aspsp.common.converter.account.FROfferConverter.toFROfferData;
import static com.forgerock.securebanking.openbanking.aspsp.common.converter.account.FRPartyConverter.toFRPartyData;
import static com.forgerock.securebanking.openbanking.aspsp.common.converter.account.FRScheduledPaymentConverter.toFRScheduledPaymentData;
import static com.forgerock.securebanking.openbanking.aspsp.common.converter.account.FRStandingOrderConverter.toFRStandingOrderData;
import static com.forgerock.securebanking.openbanking.aspsp.common.converter.account.FRStatementConverter.toFRStatementData;
import static com.forgerock.securebanking.openbanking.aspsp.common.converter.account.FRTransactionConverter.toFRTransactionData;
...
public class DataCreator {
    ...
    public DataCreator(FRAccountRepository accountsRepository, FRBalanceRepository balanceRepository,
                       ...
                       @Value("${aspsp.data.upload.limit.documents}") Integer documentLimit,
                       @Value("${aspsp.data.upload.limit.accounts}") Integer accountLimit) {
