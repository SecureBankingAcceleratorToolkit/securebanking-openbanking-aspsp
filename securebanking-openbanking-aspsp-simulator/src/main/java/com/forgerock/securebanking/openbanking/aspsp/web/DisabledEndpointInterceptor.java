 ...
 */
package com.forgerock.securebanking.openbanking.aspsp.web;

import com.forgerock.securebanking.openbanking.aspsp.discovery.ControllerEndpointBlacklistHandler;
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) {
        if (handler instanceof HandlerMethod) {
            ...
            if (blacklistHandler.isBlacklisted(handlerMethod.getBeanType(), handlerMethod.getMethod())) {
                log.warn("Request URI {} was BLOCKED due to ASPSP configuration settings. " +
