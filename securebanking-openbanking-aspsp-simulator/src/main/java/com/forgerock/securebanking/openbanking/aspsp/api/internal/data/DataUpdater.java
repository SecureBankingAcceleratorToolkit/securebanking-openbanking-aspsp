...
import com.forgerock.securebanking.common.openbanking.domain.account.data.*;
...
public class DataUpdater {
    ...
    public DataUpdater(FRAccountRepository accountsRepository, FRBalanceRepository balanceRepository,
                       ...
                       FROfferRepository offerRepository, @Value("${aspsp.data.upload.limit.documents}") Integer documentLimit) {
